...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      menu: '專案操作',
      menuRename: '重新命名',
      menuAcceptCompletion: '接受完成',
      menuAppearance: '外觀',
      menuContinueWork: '繼續工作',
      noColor: '無顏色',
      menuAddFolder: '新增資料夾',
      menuReopen: '重新開啟',
      menuResume: '繼續',
      ...
      activationFailed: '專案已建立，但無法設為作用中專案。',
      createFailed: '無法建立專案',
      mutationConflict: '專案狀態已變更。請查看最新狀態後重試。',
      mutationFailed: '無法更新專案',
      mutationPending: '請先重試或解決待處理的專案操作，然後再提交。',
      mutationRetry: 'Hermes 無法確認結果。請安全地重試相同操作。',
      runtimeApproval: '核准',
      runtimeApprovalNone: '無',
      runtimeApprovalPending: '待處理',
      runtimeBlock: '阻塞',
      runtimeBlockNone: '無',
      runtimeDelivery: '投遞',
      runtimeLifecycle: '生命週期',
      runtimePhase: '階段',
      runtimeQueue: '佇列',
      runtimeRetryPending: '等待重試',
      runtimeStatus: '專案執行狀態',
  ...
  statusStack: {
    ...
    exit: code => `結束碼 ${code}`,
    managedProject: {
      ambiguousSession: '多個受管理專案宣告了此工作階段。訊息未傳送。',
      attachmentsUnsupported: '受管理專案暫不支援附件。草稿已還原。',
      conflict: '專案已變更。請檢查正式狀態後重新提交。',
      historyUnsupported: '暫不支援受管理專案歷程變更。',
      invalidRetryReceipt: '受管理專案重試傳回了無效的佇列回條。',
      legacyDraftRecovery: '還原舊草稿',
      messageFailed: '受管理專案訊息傳送失敗。',
      missingAcceptedTurn: '受管理專案加入佇列時未傳回已接受的回合。',
      restoreDraft: '還原草稿',
      retryFailed: '受管理專案重試失敗。',
      retryRequired: '正式佇列結果不確定。請重試同一請求。',
      retryScopeChanged: '受管理專案的重試範圍已變更。',
      retryUnavailable: '受管理專案重試無法使用。',
      stopUnavailable: '受管理專案沒有可停止的執行中回合。',
      runtimeUnavailable: '受管理專案執行階段尚不可用。',
      voiceDraftRecovery: '復原語音草稿',
      voiceScopeChanged: '轉錄語音輸入時專案已變更。語音草稿已隔離。',
      title: '專案訊息'
    },
    coding: {
      title: '工作區',
  ...
  assistant: {
    ...
    clarify: {
      managedUnsupported: '受管理專案不支援澄清輸入。在 Hermes 以規範方式處理之前，此執行將保持封鎖。',
      notReady: '澄清請求尚未就緒',
      gatewayDisconnected: 'Hermes 閘道未連線',
      sendFailed: '無法傳送澄清回應',
