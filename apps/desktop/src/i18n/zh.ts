...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    projects: {
      ...
      activationFailed: '项目已创建，但无法设为活动项目。',
      createFailed: '无法创建项目',
      mutationConflict: '项目状态已更改。请查看最新状态后重试。',
      mutationFailed: '无法更新项目',
      mutationPending: '请先重试或解决待处理的项目操作，然后再提交。',
      mutationRetry: 'Hermes 无法确认结果。请安全地重试同一操作。',
      runtimeApproval: '审批',
      runtimeApprovalNone: '无',
      runtimeApprovalPending: '待处理',
      runtimeBlock: '阻塞',
      runtimeBlockNone: '无',
      runtimeDelivery: '投递',
      ...
      runtimePhase: '阶段',
      runtimeQueue: '队列',
      runtimeRetryPending: '等待重试',
      runtimeStatus: '项目运行状态',
  ...
  statusStack: {
    ...
    exit: code => `退出码 ${code}`,
    managedProject: {
      ambiguousSession: '多个托管项目声明了此会话。消息未发送。',
      attachmentsUnsupported: '托管项目暂不支持附件。草稿已恢复。',
      conflict: '项目已更改。请检查规范状态后重新提交。',
      historyUnsupported: '暂不支持托管项目历史记录更改。',
      invalidRetryReceipt: '托管项目重试返回了无效的入队回执。',
      legacyDraftRecovery: '恢复旧草稿',
      messageFailed: '托管项目消息发送失败。',
      missingAcceptedTurn: '托管项目入队未返回已接受的轮次。',
      restoreDraft: '恢复草稿',
      retryFailed: '托管项目重试失败。',
      retryRequired: '规范入队结果不确定。请重试同一请求。',
      retryScopeChanged: '托管项目的重试范围已更改。',
      retryUnavailable: '托管项目重试不可用。',
      stopUnavailable: '托管项目没有可停止的运行中轮次。',
      runtimeUnavailable: '托管项目运行时尚不可用。',
      voiceDraftRecovery: '恢复语音草稿',
      voiceScopeChanged: '转录语音输入时项目已更改。语音草稿已隔离。',
      title: '项目消息'
    },
    coding: {
      title: '工作区',
  ...
  assistant: {
    ...
    clarify: {
      managedUnsupported: '托管项目不支持澄清输入。在 Hermes 以规范方式处理之前，此运行将保持阻塞。',
      notReady: '澄清请求尚未就绪',
      gatewayDisconnected: 'Hermes 网关未连接',
      sendFailed: '无法发送澄清响应',
