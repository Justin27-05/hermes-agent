...
export const en: Translations = {
  ...
  sidebar: {
    ...
    projects: {
      ...
      activationFailed: 'Project created, but it could not be made active.',
      createFailed: 'Could not create project',
      mutationConflict: 'Project state changed. Review the latest state and try again.',
      mutationFailed: 'Could not update project',
      mutationPending: 'Retry or resolve the pending project operation before submitting again.',
      mutationRetry: 'Hermes could not confirm the result. Retry the same operation safely.',
  ...
  statusStack: {
    ...
    exit: code => `exit ${code}`,
    managedProject: {
      ambiguousSession: 'Multiple managed projects claim this session. The message was not sent.',
      attachmentsUnsupported: 'Managed project attachments are not supported yet. The draft was restored.',
      conflict: 'The project changed. Review the canonical state and submit again.',
      historyUnsupported: 'Managed project history changes are not supported yet.',
      invalidRetryReceipt: 'The managed project retry returned an invalid enqueue receipt.',
      legacyDraftRecovery: 'Legacy draft recovery',
      messageFailed: 'Managed project message failed.',
      missingAcceptedTurn: 'The managed project enqueue returned no accepted turn.',
      restoreDraft: 'Restore draft',
      retryFailed: 'Managed project retry failed.',
      retryRequired: 'The canonical enqueue result is ambiguous. Retry the same intent.',
      retryScopeChanged: 'The managed project retry scope changed.',
      retryUnavailable: 'The managed project retry is unavailable.',
      stopUnavailable: 'The managed project has no running turn to stop.',
      runtimeUnavailable: 'The managed project runtime is not available yet.',
      voiceDraftRecovery: 'Voice draft recovery',
      voiceScopeChanged:
        'The project changed while voice input was being transcribed. The voice draft was quarantined.',
  ...
  assistant: {
    ...
    clarify: {
      managedUnsupported:
        'Clarify input is not supported for managed projects. This run remains blocked until Hermes handles it canonically.',
