...
export const ar = defineLocale({
  ...
  sidebar: {
    ...
    projects: {
      ...
      menuAcceptCompletion: 'قبول الإكمال',
      menuAppearance: 'المظهر',
      menuContinueWork: 'متابعة العمل',
      noColor: 'بلا لون',
      menuAddFolder: 'إضافة مجلد',
      menuReopen: 'إعادة الفتح',
      menuResume: 'استئناف',
      ...
      activationFailed: 'تم إنشاء المشروع، ولكن تعذّر جعله نشطًا.',
      createFailed: 'تعذّر إنشاء المشروع',
      mutationConflict: 'تغيّرت حالة المشروع. راجع أحدث حالة وحاول مرة أخرى.',
      mutationFailed: 'تعذّر تحديث المشروع',
      mutationPending: 'أعد محاولة عملية المشروع المعلّقة أو قم بحلها قبل الإرسال مرة أخرى.',
      mutationRetry: 'تعذّر على Hermes تأكيد النتيجة. أعد محاولة العملية نفسها بأمان.',
      runtimeApproval: 'الموافقة',
      runtimeApprovalNone: 'لا يوجد',
      runtimeApprovalPending: 'معلّقة',
      runtimeBlock: 'الحظر',
      runtimeBlockNone: 'لا يوجد',
      runtimeDelivery: 'التسليم',
      runtimeLifecycle: 'دورة الحياة',
      runtimePhase: 'المرحلة',
      runtimeQueue: 'قائمة الانتظار',
      runtimeRetryPending: 'إعادة المحاولة معلّقة',
      runtimeStatus: 'حالة تشغيل المشروع',
  ...
  statusStack: {
    ...
    exit: code => `خروج ${code}`,
    managedProject: {
      ambiguousSession: 'تدّعي عدة مشاريع مُدارة ملكية هذه الجلسة. لم تُرسل الرسالة.',
      attachmentsUnsupported: 'مرفقات المشاريع المُدارة غير مدعومة بعد. تمت استعادة المسودة.',
      conflict: 'تغيّر المشروع. راجع الحالة الأساسية ثم أرسل مجددًا.',
      historyUnsupported: 'تغييرات سجل المشروع المُدار غير مدعومة بعد.',
      invalidRetryReceipt: 'أعادت محاولة رسالة المشروع إيصال إضافة غير صالح.',
      legacyDraftRecovery: 'استعادة المسودة القديمة',
      messageFailed: 'فشلت رسالة المشروع المُدار.',
      missingAcceptedTurn: 'لم تُرجع إضافة المشروع دورًا مقبولًا.',
      restoreDraft: 'استعادة المسودة',
      retryFailed: 'فشلت إعادة محاولة المشروع المُدار.',
      retryRequired: 'نتيجة الإضافة الأساسية غير مؤكدة. أعد محاولة نفس الطلب.',
      retryScopeChanged: 'تغيّر نطاق المشروع المُدار.',
      retryUnavailable: 'إعادة محاولة رسالة المشروع المُدار غير متاحة.',
      stopUnavailable: 'لا يحتوي المشروع المُدار على دور قيد التشغيل لإيقافه.',
      runtimeUnavailable: 'وقت تشغيل المشروع المُدار غير متاح بعد.',
      voiceDraftRecovery: 'استعادة مسودة صوتية',
      voiceScopeChanged: 'تغيّر المشروع أثناء نسخ الإدخال الصوتي. تم عزل المسودة الصوتية.',
      title: 'رسالة المشروع'
    },
    coding: {
      title: 'شجرة العمل',
  ...
  assistant: {
    ...
    clarify: {
      managedUnsupported:
        'إدخال التوضيح غير مدعوم للمشروعات المُدارة. سيظل التشغيل محظورًا حتى يعالجه Hermes بشكل أساسي.',
      notReady: 'غير جاهز',
      gatewayDisconnected: 'البوابة غير متصلة',
      sendFailed: 'فشل الإرسال',
